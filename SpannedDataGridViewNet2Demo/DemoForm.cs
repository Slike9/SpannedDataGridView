    ...
    public partial class DemoForm : Form
    {
        ...
        public DemoForm()
        {
            ...
            foreach(DataGridViewColumn column in dataGridView1.Columns)
                columns.Add(column);
            dtGrdVwColumnsProperties.DataSource = columns;
            ...
            List<RowPresenter> rows = new List<RowPresenter>();
            foreach (DataGridViewRow row in dataGridView1.Rows)
                rows.Add(new RowPresenter(row));
            dtGrdVwRowsProperties.DataSource = rows;
